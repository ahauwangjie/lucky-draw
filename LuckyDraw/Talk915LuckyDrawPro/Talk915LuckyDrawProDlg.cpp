...
BOOL CTalk915LuckyDrawProDlg::OnInitDialog()
{
	...
	m_font.CreatePointFont(120, _T("楷体"));
	GetDlgItem(IDC_STATIC_ALL_LUCY_NAME)->SetFont(&m_font);
	GetDlgItem(IDC_STATIC_ALL_LUCY_NAME)->SetWindowTextW(L"一等奖1名    二等奖2名    三等奖3名    四等奖5名    五等奖8名");

	m_font.CreatePointFont(160, _T("黑体"));
	...
	//GetDlgItem(IDC_STATIC_LEVEL_1)->SetWindowTextW(L"一等奖(1名)：");
	//GetDlgItem(IDC_STATIC_LEVEL_2)->SetWindowTextW(L"二等奖(2名)：");
	//GetDlgItem(IDC_STATIC_LEVEL_3)->SetWindowTextW(L"三等奖(3名)：");
	//GetDlgItem(IDC_STATIC_LEVEL_4)->SetWindowTextW(L"四等奖(5名)：");
	//GetDlgItem(IDC_STATIC_LEVEL_5)->SetWindowTextW(L"五等奖(8名)：");
